...
class WriteTime(TestCase):
    ...
    def test_write_intra_day_time_with_setting_false(self, mock_environ):
        mock_environ.USE_CLOCK_FORMAT_FOR_INTRA_DAY = False
    ...
    def test_write_intra_day_time_with_setting_true(self, mock_environ):
        mock_environ.USE_CLOCK_FORMAT_FOR_INTRA_DAY.return_value = True
    ...
    def test_write_end_of_day_time_with_setting_false(self, mock_environ):
        mock_environ.USE_CLOCK_FORMAT_FOR_INTRA_DAY = False
    ...
    def test_write_end_of_day_time_with_setting_true(self, mock_environ):
        mock_environ.USE_CLOCK_FORMAT_FOR_INTRA_DAY = True
